...
drop table customer_income_critiria;
...
drop table customer_income_status;
...
drop table loan_update_details;
...
create table customer_interest_analaysis (select c.loan_id,c.Customer_id,c.applicantincome,c.property_area,
...
select c.*,i.* from customer_det c
...
drop procedure customer_full_details;
